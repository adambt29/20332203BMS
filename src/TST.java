...
//code mainly taken from book and lecture slides.
public class TST<Value> 
{
    ...
    private class Queue<Item> implements Iterable<Item> 
    {
        ...
        {
            return new Link(first);
        }

        // essentially the main from program 
        private class Link implements Iterator<Item>
        {
            private Node<Item> current;

            public Link(Node<Item> first)
            {
                current = first;
            }
